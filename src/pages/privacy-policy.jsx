  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Your Data Protection and Security Assurance | Privacy Policy | 10m
          Blogs"
        />
        <meta
        ...
        <title>
          Your Data Protection and Security Assurance | Privacy Policy | 10m
          Blogs
        </title>
      </Head>
      <div className="mx-auto w-2/3 leading-10 my-10">
        ...
        <ul>
          <li>By email: mdp020479@gmail.com</li>
        </ul>
      </div>
    </>
  );
